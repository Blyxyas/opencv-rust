...
// BM3D_STEP1 /usr/include/opencv2/xphoto/bm3d_image_denoising.hpp:73
pub const BM3D_STEP1: i32 = 1;
/// Execute only second step of the algorithm
// BM3D_STEP2 /usr/include/opencv2/xphoto/bm3d_image_denoising.hpp:75
pub const BM3D_STEP2: i32 = 2;
/// Execute all steps of the algorithm
// BM3D_STEPALL /usr/include/opencv2/xphoto/bm3d_image_denoising.hpp:71
pub const BM3D_STEPALL: i32 = 0;
/// Un-normalized Haar transform
// HAAR /usr/include/opencv2/xphoto/bm3d_image_denoising.hpp:64
...
/// See [GenserPCS2018](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_GenserPCS2018) and [SeilerTIP2015](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_SeilerTIP2015) for details.
/// 
...
///    [GroscheICIP2018](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_GroscheICIP2018) and [GroscheIST2018](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_GroscheIST2018).
/// 
...
// INPAINT_FSR_BEST /usr/include/opencv2/xphoto/inpainting.hpp:94
pub const INPAINT_FSR_BEST: i32 = 1;
/// See #INPAINT_FSR_BEST
// INPAINT_FSR_FAST /usr/include/opencv2/xphoto/inpainting.hpp:95
...
/// transformations
// INPAINT_SHIFTMAP /usr/include/opencv2/xphoto/inpainting.hpp:74
pub const INPAINT_SHIFTMAP: i32 = 0;
/// BM3D algorithm steps
// Bm3dSteps /usr/include/opencv2/xphoto/bm3d_image_denoising.hpp:68
#[repr(C)]
...
/// ## See also
/// inpaint
// InpaintTypes /usr/include/opencv2/xphoto/inpainting.hpp:69
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// TransformTypes /usr/include/opencv2/xphoto/bm3d_image_denoising.hpp:61
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
/// 
/// See the original papers [He2012](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_He2012) (Shiftmap) or [GenserPCS2018](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_GenserPCS2018) and [SeilerTIP2015](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_SeilerTIP2015) (FSR) for details.
/// 
/// ## Parameters
/// * src: source image
...
/// oilPainting
/// See the book [Holzmann1988](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_Holzmann1988) for details.
/// ## Parameters
...
// GrayworldWB /usr/include/opencv2/xphoto/white_balance.hpp:139
...
/// [Cheng2015](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_Cheng2015) .
/// 
...
/// 
/// Currently supports images of type @ref CV_8UC3 and @ref CV_16UC3.
// LearningBasedWB /usr/include/opencv2/xphoto/white_balance.hpp:168
...
pub trait LearningBasedWB: crate::xphoto::LearningBasedWBConst + crate::xphoto::WhiteBalancer {
	...
	/// 
	/// In accordance with [Cheng2015](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_Cheng2015) , computes the following features for the input image:
...
// SimpleWB /usr/include/opencv2/xphoto/white_balance.hpp:79
...
/// 
/// For more information see [DD02](https://docs.opencv.org/4.6.0/d0/de3/citelist.html#CITEREF_DD02) .
// TonemapDurand /usr/include/opencv2/xphoto/tonemap.hpp:24
...
// WhiteBalancer /usr/include/opencv2/xphoto/white_balance.hpp:63
