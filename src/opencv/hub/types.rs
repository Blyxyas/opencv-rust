...
mod barcode_types {
	...
	vector_extern! { crate::barcode::BarcodeType, *const c_void, *mut c_void,
		...
		cv_VectorOfBarcodeType_capacity, cv_VectorOfBarcodeType_resize,
		cv_VectorOfBarcodeType_shrink_to_fit,
...
mod core_types {
	...
	vector_extern! { core::DMatch, *const c_void, *mut c_void,
		...
		cv_VectorOfDMatch_capacity, cv_VectorOfDMatch_resize,
		cv_VectorOfDMatch_shrink_to_fit,
	...
	vector_extern! { core::GpuMat, *const c_void, *mut c_void,
		...
		cv_VectorOfGpuMat_capacity, cv_VectorOfGpuMat_resize,
		cv_VectorOfGpuMat_shrink_to_fit,
	...
	vector_extern! { core::KeyPoint, *const c_void, *mut c_void,
		...
		cv_VectorOfKeyPoint_capacity, cv_VectorOfKeyPoint_resize,
		cv_VectorOfKeyPoint_shrink_to_fit,
	...
	vector_extern! { core::Mat, *const c_void, *mut c_void,
		...
		cv_VectorOfMat_capacity, cv_VectorOfMat_resize,
		cv_VectorOfMat_shrink_to_fit,
	...
	vector_extern! { core::Point, *const c_void, *mut c_void,
		...
		cv_VectorOfPoint_capacity, cv_VectorOfPoint_resize,
		cv_VectorOfPoint_shrink_to_fit,
	...
	vector_extern! { core::Point2f, *const c_void, *mut c_void,
		...
		cv_VectorOfPoint2f_capacity, cv_VectorOfPoint2f_resize,
		cv_VectorOfPoint2f_shrink_to_fit,
	...
	vector_extern! { core::Point3d, *const c_void, *mut c_void,
		...
		cv_VectorOfPoint3d_capacity, cv_VectorOfPoint3d_resize,
		cv_VectorOfPoint3d_shrink_to_fit,
	...
	vector_extern! { core::Point3f, *const c_void, *mut c_void,
		...
		cv_VectorOfPoint3f_capacity, cv_VectorOfPoint3f_resize,
		cv_VectorOfPoint3f_shrink_to_fit,
	...
	vector_extern! { core::Point3i, *const c_void, *mut c_void,
		...
		cv_VectorOfPoint3i_capacity, cv_VectorOfPoint3i_resize,
		cv_VectorOfPoint3i_shrink_to_fit,
	...
	vector_extern! { core::Range, *const c_void, *mut c_void,
		...
		cv_VectorOfRange_capacity, cv_VectorOfRange_resize,
		cv_VectorOfRange_shrink_to_fit,
	...
	vector_extern! { core::Rect, *const c_void, *mut c_void,
		...
		cv_VectorOfRect_capacity, cv_VectorOfRect_resize,
		cv_VectorOfRect_shrink_to_fit,
	...
	vector_extern! { core::Rect2d, *const c_void, *mut c_void,
		...
		cv_VectorOfRect2d_capacity, cv_VectorOfRect2d_resize,
		cv_VectorOfRect2d_shrink_to_fit,
	...
	vector_extern! { core::RotatedRect, *const c_void, *mut c_void,
		...
		cv_VectorOfRotatedRect_capacity, cv_VectorOfRotatedRect_resize,
		cv_VectorOfRotatedRect_shrink_to_fit,
	...
	vector_extern! { String, *const c_void, *mut c_void,
		...
		cv_VectorOfString_capacity, cv_VectorOfString_resize,
		cv_VectorOfString_shrink_to_fit,
	...
	vector_extern! { core::UMat, *const c_void, *mut c_void,
		...
		cv_VectorOfUMat_capacity, cv_VectorOfUMat_resize,
		cv_VectorOfUMat_shrink_to_fit,
	...
	vector_extern! { core::Vec3d, *const c_void, *mut c_void,
		...
		cv_VectorOfVec3d_capacity, cv_VectorOfVec3d_resize,
		cv_VectorOfVec3d_shrink_to_fit,
	...
	vector_extern! { core::Vec3f, *const c_void, *mut c_void,
		...
		cv_VectorOfVec3f_capacity, cv_VectorOfVec3f_resize,
		cv_VectorOfVec3f_shrink_to_fit,
	...
	vector_extern! { core::Vector<core::Mat>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfMat_capacity, cv_VectorOfVectorOfMat_resize,
		cv_VectorOfVectorOfMat_shrink_to_fit,
	...
	vector_extern! { core::Vector<core::Point>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfPoint_capacity, cv_VectorOfVectorOfPoint_resize,
		cv_VectorOfVectorOfPoint_shrink_to_fit,
	...
	vector_extern! { core::Vector<core::Point3d>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfPoint3d_capacity, cv_VectorOfVectorOfPoint3d_resize,
		cv_VectorOfVectorOfPoint3d_shrink_to_fit,
	...
	vector_extern! { core::Vector<core::Point3f>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfPoint3f_capacity, cv_VectorOfVectorOfPoint3f_resize,
		cv_VectorOfVectorOfPoint3f_shrink_to_fit,
	...
	vector_extern! { core::Vector<core::Point3i>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfPoint3i_capacity, cv_VectorOfVectorOfPoint3i_resize,
		cv_VectorOfVectorOfPoint3i_shrink_to_fit,
	...
	vector_extern! { core::Vector<core::Vec3f>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfVec3f_capacity, cv_VectorOfVectorOfVec3f_resize,
		cv_VectorOfVectorOfVec3f_shrink_to_fit,
	...
	vector_extern! { core::Vector<f32>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOff32_capacity, cv_VectorOfVectorOff32_resize,
		cv_VectorOfVectorOff32_shrink_to_fit,
	...
	vector_extern! { core::Vector<i32>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfi32_capacity, cv_VectorOfVectorOfi32_resize,
		cv_VectorOfVectorOfi32_shrink_to_fit,
	...
	vector_extern! { bool, *const c_void, *mut c_void,
		...
		cv_VectorOfbool_capacity, cv_VectorOfbool_resize,
		cv_VectorOfbool_shrink_to_fit,
	...
	vector_extern! { f32, *const c_void, *mut c_void,
		...
		cv_VectorOff32_capacity, cv_VectorOff32_resize,
		cv_VectorOff32_shrink_to_fit,
	...
	vector_extern! { f64, *const c_void, *mut c_void,
		...
		cv_VectorOff64_capacity, cv_VectorOff64_resize,
		cv_VectorOff64_shrink_to_fit,
	...
	vector_extern! { i32, *const c_void, *mut c_void,
		...
		cv_VectorOfi32_capacity, cv_VectorOfi32_resize,
		cv_VectorOfi32_shrink_to_fit,
	...
	vector_extern! { size_t, *const c_void, *mut c_void,
		...
		cv_VectorOfsize_t_capacity, cv_VectorOfsize_t_resize,
		cv_VectorOfsize_t_shrink_to_fit,
	...
	vector_extern! { u8, *const c_void, *mut c_void,
		...
		cv_VectorOfu8_capacity, cv_VectorOfu8_resize,
		cv_VectorOfu8_shrink_to_fit,
...
mod dnn_types {
	...
	vector_extern! { core::Ptr<crate::dnn::BackendNode>, *const c_void, *mut c_void,
		...
		cv_VectorOfPtrOfBackendNode_capacity, cv_VectorOfPtrOfBackendNode_resize,
		cv_VectorOfPtrOfBackendNode_shrink_to_fit,
	...
	vector_extern! { core::Ptr<dyn crate::dnn::BackendWrapper>, *const c_void, *mut c_void,
		...
		cv_VectorOfPtrOfBackendWrapper_capacity, cv_VectorOfPtrOfBackendWrapper_resize,
		cv_VectorOfPtrOfBackendWrapper_shrink_to_fit,
	...
	vector_extern! { core::Ptr<crate::dnn::Layer>, *const c_void, *mut c_void,
		...
		cv_VectorOfPtrOfLayer_capacity, cv_VectorOfPtrOfLayer_resize,
		cv_VectorOfPtrOfLayer_shrink_to_fit,
	...
	vector_extern! { crate::dnn::Target, *const c_void, *mut c_void,
		...
		cv_VectorOfTarget_capacity, cv_VectorOfTarget_resize,
		cv_VectorOfTarget_shrink_to_fit,
	...
	vector_extern! { core::Vector<crate::dnn::MatShape>, *const c_void, *mut c_void,
		...
		cv_VectorOfVectorOfMatShape_capacity, cv_VectorOfVectorOfMatShape_resize,
		cv_VectorOfVectorOfMatShape_shrink_to_fit,
...
mod dpm_types {
	...
	vector_extern! { crate::dpm::DPMDetector_ObjectDetection, *const c_void, *mut c_void,
		...
		cv_VectorOfDPMDetector_ObjectDetection_capacity, cv_VectorOfDPMDetector_ObjectDetection_resize,
		cv_VectorOfDPMDetector_ObjectDetection_shrink_to_fit,
