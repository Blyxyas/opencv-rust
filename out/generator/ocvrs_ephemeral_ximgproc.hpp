...
namespace cv {
	OCVRS_ONLY_DEPENDENT_TYPES void dependent_types_dummy(
		cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategyColor>,
		cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategyFill>,
		cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategyMultiple>,
		cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategySize>,
		cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategyTexture>
	) {}
}