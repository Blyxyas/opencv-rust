...
// CCM_3x3 /usr/include/opencv2/mcc/ccm.hpp:61
...
// DISTANCE_CIE76 /usr/include/opencv2/mcc/ccm.hpp:346
pub const DISTANCE_CIE76: i32 = 0;
/// The 1976 definition was extended to address perceptual non-uniformities.
// DISTANCE_CIE94_GRAPHIC_ARTS /usr/include/opencv2/mcc/ccm.hpp:347
pub const DISTANCE_CIE94_GRAPHIC_ARTS: i32 = 1;
// DISTANCE_CIE94_TEXTILES /usr/include/opencv2/mcc/ccm.hpp:348
...
// LINEARIZATION_COLORLOGPOLYFIT /usr/include/opencv2/mcc/ccm.hpp:335
...
// LINEARIZATION_COLORPOLYFIT /usr/include/opencv2/mcc/ccm.hpp:334
pub const LINEARIZATION_COLORPOLYFIT: i32 = 2;
/// gamma correction; Need assign a value to gamma simultaneously
// LINEARIZATION_GAMMA /usr/include/opencv2/mcc/ccm.hpp:333
...
// LINEARIZATION_GRAYLOGPOLYFIT /usr/include/opencv2/mcc/ccm.hpp:337
...
// LINEARIZATION_GRAYPOLYFIT /usr/include/opencv2/mcc/ccm.hpp:336
pub const LINEARIZATION_GRAYPOLYFIT: i32 = 4;
/// no change is made
// LINEARIZATION_IDENTITY /usr/include/opencv2/mcc/ccm.hpp:332
pub const LINEARIZATION_IDENTITY: i32 = 0;
/// Standard Macbeth Chart with 24 squares
// MCC24 /usr/include/opencv2/mcc/checker_model.hpp:48
pub const MCC_MCC24: i32 = 0;
/// DigitalSG with 140 squares
// SG140 /usr/include/opencv2/mcc/checker_model.hpp:49
pub const MCC_SG140: i32 = 1;
/// DKK color chart with 12 squares and 6 rectangle
// VINYL18 /usr/include/opencv2/mcc/checker_model.hpp:50
pub const MCC_VINYL18: i32 = 2;
/// Enum of the possible types of ccm.
// CCM_TYPE /usr/include/opencv2/mcc/ccm.hpp:59
#[repr(C)]
...
// COLOR_SPACE /usr/include/opencv2/mcc/ccm.hpp:93
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// CONST_COLOR /usr/include/opencv2/mcc/ccm.hpp:88
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// DISTANCE_TYPE /usr/include/opencv2/mcc/ccm.hpp:344
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// INITIAL_METHOD_TYPE /usr/include/opencv2/mcc/ccm.hpp:67
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// LINEAR_TYPE /usr/include/opencv2/mcc/ccm.hpp:329
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// TYPECHART /usr/include/opencv2/mcc/checker_model.hpp:46
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq)]
...
// ColorCorrectionModel /usr/include/opencv2/mcc/ccm.hpp:360
...
///    etc.
// CChecker /usr/include/opencv2/mcc/checker_model.hpp:64
...
pub trait MCC_CChecker: crate::mcc::MCC_CCheckerConst {
	...
	fn set_box(&mut self, mut _box: core::Vector<core::Point2f>) -> Result<()> {
		return_send!(via ocvrs_return);
		unsafe { sys::cv_mcc_CChecker_setBox_vector_Point2f_(self.as_raw_mut_MCC_CChecker(), _box.as_raw_mut_VectorOfPoint2f(), ocvrs_return.as_mut_ptr()) };
		return_receive!(unsafe ocvrs_return => ret);
		let ret = ret.into_result()?;
		Ok(ret)
	}
...
// CCheckerDetector /usr/include/opencv2/mcc/checker_detector.hpp:129
...
pub trait MCC_CCheckerDetector: core::AlgorithmTrait + crate::mcc::MCC_CCheckerDetectorConst {
	...
	fn process(&mut self, image: &dyn core::ToInputArray, chart_type: crate::mcc::MCC_TYPECHART, nc: i32, use_net: bool, params: &core::Ptr<crate::mcc::MCC_DetectorParameters>) -> Result<bool> {
		input_array_arg!(image);
		return_send!(via ocvrs_return);
		unsafe { sys::cv_mcc_CCheckerDetector_process_const__InputArrayR_const_TYPECHART_const_int_bool_const_Ptr_DetectorParameters_R(self.as_raw_mut_MCC_CCheckerDetector(), image.as_raw__InputArray(), chart_type, nc, use_net, params.as_raw_PtrOfMCC_DetectorParameters(), ocvrs_return.as_mut_ptr()) };
		return_receive!(unsafe ocvrs_return => ret);
		let ret = ret.into_result()?;
		Ok(ret)
	}
...
// CCheckerDraw /usr/include/opencv2/mcc/checker_model.hpp:112
...
impl dyn MCC_CCheckerDraw + '_ {
	...
	pub fn create(mut p_checker: core::Ptr<dyn crate::mcc::MCC_CChecker>, color: core::Scalar, thickness: i32) -> Result<core::Ptr<dyn crate::mcc::MCC_CCheckerDraw>> {
		return_send!(via ocvrs_return);
		unsafe { sys::cv_mcc_CCheckerDraw_create_Ptr_CChecker__Scalar_int(p_checker.as_raw_mut_PtrOfMCC_CChecker(), color.opencv_as_extern(), thickness, ocvrs_return.as_mut_ptr()) };
		return_receive!(unsafe ocvrs_return => ret);
		let ret = ret.into_result()?;
...
///                           detected. default(4)
// DetectorParameters /usr/include/opencv2/mcc/checker_detector.hpp:99
